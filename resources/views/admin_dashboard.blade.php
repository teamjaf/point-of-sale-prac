...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Total POS by Teamjaaf</title>
    ...
    <body data-layout-mode="default" data-theme="dark" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="dark" data-leftbar-size='default' data-sidebar-user='false'>
        ...
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
         ...
         <script src="{{asset('backend/assets/libs/datatables.net-resp')}}onsive/js/dataTables.responsive.min.js')}}"></script>
